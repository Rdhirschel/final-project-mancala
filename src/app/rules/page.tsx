  ...
  return (
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-5xl mx-auto py-12 px-6">
        <h1 className="text-4xl font-bold text-center mb-10 text-slate-900">Mancala Rules</h1>
        
        <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-slate-300">
          <h2 className="text-3xl font-bold mb-6 text-slate-900 border-b-4 border-slate-800 pb-2">Game Setup</h2>
          <p className="mb-6 text-xl text-slate-900 font-medium">
          ...
          <div className="my-10 flex justify-center">
            <img 
              ...
              alt="Mancala Board" 
              className="max-w-full h-auto rounded-lg shadow-lg border-4 border-slate-400" 
            />
          </div>
          
          <h2 className="text-3xl font-bold mb-6 text-slate-900 border-b-4 border-slate-800 pb-2">Objective</h2>
          <p className="mb-6 text-xl text-slate-900 font-medium">
            The goal is to collect more stones in your store than your opponent by the end of the game.
          </p>
          
          <h2 className="text-3xl font-bold mb-6 text-slate-900 border-b-4 border-slate-800 pb-2">Game Play</h2>
          <ol className="list-decimal pl-8 space-y-4 mb-8 text-lg">
            <li className="p-4 bg-slate-800 text-white rounded font-medium">
          ...
          <h2 className="text-3xl font-bold mb-6 text-slate-900 border-b-4 border-slate-800 pb-2">Strategy Tips</h2>
          <ul className="list-disc pl-8 space-y-3 text-lg">
            <li className="p-4 bg-yellow-600 text-white rounded font-medium">Try to end your turn in your Mancala to get an extra move</li>
            <li className="p-4 bg-yellow-600 text-white rounded font-medium">Keep track of how many stones are in each pit to plan captures</li>
            <li className="p-4 bg-yellow-600 text-white rounded font-medium">Sometimes it's better to keep stones on your side to set up future moves</li>
            <li className="p-4 bg-yellow-600 text-white rounded font-medium">Sabotaging the Enemy moves by distributing stones in their side can be beneficial</li>
          </ul>
        </div>
      </div>
    </div>
